...
/*Task 1: counterMaker()
  ...
  count is defined outside of the function
  2. Which of the two uses a closure? How can you tell?
  counterMaker uses a closure I can tell because it is called outside the function
...
function scoreboard(getInningScorecb, inningcb, num) {
  ...
  scoreByInning.push(`extra innings ahead: Away ${currentInning.Away} - Home ${currentInning.Home}`)
}else{
